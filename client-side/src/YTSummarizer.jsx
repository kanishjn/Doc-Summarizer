...
function YTSummarizer(){
  ...
  try {
    if (currentUrl) {
      ...
      const response = await axios.post(`${API_BASE}/yt_upload`, formData, {
    ...
    async function handlePrompt(){
      ...
      try{
        ...
        aiResponse = await axios.post(`${API_BASE}/yt_ask`, { question: trimmedPrompt,user_id: sessionStorage.getItem("userId")}, {
  headers: {
